 ...
 */
public class TestAcceptanceCrossFunctional extends TestCase {
   ...
   *@since
   */
  public TestAcceptanceCrossFunctional(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    ...
    suite.addTest(new TestAcceptanceCrossFunctional("testStoreAndFetch"));
    suite.addTest(new TestAcceptanceCrossFunctional("testStoreAndDelete"));
    suite.addTest(new TestAcceptanceCrossFunctional("testUpdate"));
    return suite;
  }
