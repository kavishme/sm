...
public class FileStorage implements SM {
	...
	// }
	//
	// private MappedByteBuffer allocateBuffer( long _fileSize ) throws
	// java.io.IOException
	// {
	// long l_position = 0;
	// return m_fileChannel.map( FileChannel.MapMode.READ_WRITE, l_position,
	// _fileSize );
	// }
	...
	public void printBuffer(String prefix, ByteBuffer buffer) throws Exception {
