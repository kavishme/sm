...
public class TestStressLargeRecords extends TestCase
{
    ...
    static public Test suite ()
    {
        ...
        suite.addTest( new TestStressLargeRecords( "testStoreLargeRecord" ) );
        suite.addTest( new TestStressLargeRecords( "testFetchLargeRecord" ) );
        suite.addTest( new TestStressLargeRecords( "testClose" ) );
        return suite;
    }
}
