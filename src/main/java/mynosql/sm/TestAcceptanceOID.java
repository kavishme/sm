...
public class TestAcceptanceOID extends TestCase
{
    ...
    public TestAcceptanceOID( String _name )
    {
        super( _name );
    }
    ...
    static public Test suite ()
    {
        ...
        suite.addTest( new TestAcceptanceOID( "testStoreOID" ) );
        suite.addTest( new TestAcceptanceOID( "testFetchOID" ) );
        suite.addTest( new TestAcceptanceOID( "testClose" ) );
        return suite;
    }
}
